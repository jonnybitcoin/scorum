...
struct request_account_recovery_operation : public base_operation
{
    ...
    authority
        new_owner_authority; ///< The new owner authority the account to recover wishes to have. This is secret
...
FC_REFLECT(scorum::protocol::account_update_operation, (account)(owner)(active)(posting)(memo_key)(json_metadata))
...
FC_REFLECT(
    scorum::protocol::comment_operation, (parent_author)(parent_permlink)(author)(permlink)(title)(body)(json_metadata))
...
FC_REFLECT(scorum::protocol::custom_binary_operation,
...
FC_REFLECT(scorum::protocol::comment_options_operation,
    (author)(permlink)(max_accepted_payout)(percent_scrs)(allow_votes)(allow_curation_rewards)(extensions))

FC_REFLECT(scorum::protocol::escrow_transfer_operation,
    (from)(to)(scorum_amount)(escrow_id)(agent)(fee)(json_meta)(ratification_deadline)(escrow_expiration));
...
FC_REFLECT(scorum::protocol::request_account_recovery_operation,
    (recovery_account)(account_to_recover)(new_owner_authority)(extensions));
FC_REFLECT(scorum::protocol::recover_account_operation,
