...
raw_block_api_impl::raw_block_api_impl( scorum::app::application& _app ) : app( _app )
{}

std::shared_ptr< scorum::plugin::raw_block::raw_block_plugin > raw_block_api_impl::get_plugin()
{
...
raw_block_api::raw_block_api( const scorum::app::api_context& ctx )
{
