...
debug_node_api_impl::debug_node_api_impl( scorum::app::application& _app ) : app( _app )
{
...
{
   return get_plugin()->debug_generate_blocks( debug_key, count, scorum::chain::database::skip_nothing, 0, &key_storage );
}
...
{
   return get_plugin()->debug_generate_blocks_until( debug_key, head_block_time, generate_sparsely, scorum::chain::database::skip_nothing, &key_storage );
}
