...
public:
     ...
     * contains a serialized authority object, so there is an example below on how to pass in the authority.
     *
...
FC_REFLECT(scorum::wallet::wallet_data, (cipher_keys)(ws_server)(ws_user)(ws_password))
...
FC_API(scorum::wallet::wallet_api,
    /// wallet api
    (help)(gethelp)(about)(is_new)(is_locked)(lock)(unlock)(set_password)(load_wallet_file)(save_wallet_file)

    /// key api
    (import_key)(suggest_brain_key)(list_keys)(get_private_key)(get_private_key_from_password)(normalize_brain_key)

    /// query api
    (info)(list_my_accounts)(list_accounts)(list_witnesses)(get_witness)(get_account)(get_block)(get_ops_in_block)(
    ...
    (create_account)(create_account_with_keys)(create_account_delegated)(create_account_with_keys_delegated)(
        ...
        vote_for_witness)(follow)(transfer)(escrow_transfer)(escrow_approve)(escrow_dispute)(escrow_release)(
        transfer_to_vesting)(withdraw_vesting)(set_withdraw_vesting_route)(post_comment)(vote)(
        set_transaction_expiration)(challenge)(prove)(request_account_recovery)(recover_account)(
        change_recovery_account)(get_owner_history)(get_encrypted_memo)(decrypt_memo)(decline_voting_rights)(
    ...
    (get_prototype_operation)(serialize_transaction)(sign_transaction)
        ...
        (network_add_nodes)(network_get_connected_peers)
            ...
            (get_active_witnesses)(get_transaction))
