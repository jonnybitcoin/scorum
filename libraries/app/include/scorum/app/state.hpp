...
FC_REFLECT( scorum::app::order_history_item, (time)(type)(sbd_quantity)(steem_quantity)(real_price) );
...
FC_REFLECT( scorum::app::candle_stick, (open_time)(period)(high)(low)(open)(close)(steem_volume)(dollar_volume) );
