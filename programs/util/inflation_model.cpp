...
using scorum::protocol::calc_percent_reward_per_block;
using scorum::protocol::calc_percent_reward_per_round;
using scorum::protocol::calc_percent_reward_per_hour;
