...
void check_variant( const std::string& s, const scorum::protocol::fixed_string< Storage >& fs )
{
   fc::variant vs, vfs;
   fc::to_variant( s, vs );
...
template< typename Storage >
void check_pack( const std::string& s, const scorum::protocol::fixed_string< Storage >& fs )
{
